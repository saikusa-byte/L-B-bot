    ...
    for event in data.get('events', []):
        ...
        if source_type in ('group', 'room') and group_id:
            ...
            if is_structured_p1 or is_freeform_p1:
                ...
                replies = [
                    f"📋 {name}さん、勇気ある共有をありがとうございます。問題を隠さず声に出せる誠実さが、L&Bをより強い組織にします。記録しました。",
                    f"📋 {name}さん、ありがとうございます。この事象をいち早く察知して報告してくれた危機予測の力は、本当に大切なプロの資質です。記録しました。",
                    f"📋 {name}さん、正直に共有してくれてありがとうございます。誠実であることが、チームの信頼の土台になっています。記録しました。",
                    f"📋 {name}さん、ありがとうございます。問題が起きたとき、すぐに動いて共有できる行動力と勇気は、簡単にできることではありません。記録しました。",
                    f"📋 {name}さん、貴重な報告をありがとうございます。リスクを見抜いて対策まで考えられる力が、会社を守っています。記録しました。",
                    f"📋 {name}さん、ありがとうございます。起きたことを隠さず、改善につなげようとする誠実な姿勢に感謝します。この積み重ねが強い会社をつくります。記録しました。",
                    f"📋 {name}さん、報告してくれてありがとうございます。失敗を共有する勇気こそが、チーム全体の成長を生む力です。記録しました。",
                ]
